...
│
├── components/
│   ├── profile-card.tsx   # Card de perfil com swipe
│   ├── bottom-nav.tsx     # Navegação inferior
│   ├── match-modal.tsx    # Modal de match
│   ├── filter-dialog.tsx  # Filtros de busca
│   └── ui/                # Componentes shadcn/ui
│
├── lib/
│   ├── auth-context.tsx      # Contexto de autenticação
│   ├── matches-context.tsx   # Gerenciamento de matches
...
│   ├── 02-create-functions.sql  # Funções SQL
│   └── 03-enable-rls.sql        # Segurança RLS
│
